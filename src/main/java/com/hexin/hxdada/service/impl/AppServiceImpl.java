...
import com.hexin.hxdada.mapper.AppMapper;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(ScoringStrategyEnum.getEnumByValue(scoringStrategy)==null, ErrorCode.PARAMS_ERROR,"评分策略非法");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
        ...
        if (reviewStatus != null) {
            ThrowUtils.throwIf(ReviewStatusEnum.getEnumByValue(reviewStatus) == null, ErrorCode.PARAMS_ERROR, "审核状态非法");
        }
    }
