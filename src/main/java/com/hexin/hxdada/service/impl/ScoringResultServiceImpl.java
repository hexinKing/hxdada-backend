...
import com.hexin.hxdada.mapper.ScoringResultMapper;
import com.hexin.hxdada.model.dto.scoringresult.ScoringResultQueryRequest;
...
import com.hexin.hxdada.model.vo.ScoringResultVO;
...
public class ScoringResultServiceImpl extends ServiceImpl<ScoringResultMapper, ScoringResult> implements ScoringResultService {
    ...
    public void validScoringResult(ScoringResult scoringResult, boolean add) {
        ...
        if (StringUtils.isNotBlank(resultName)) {
            ThrowUtils.throwIf(resultName.length() > 128, ErrorCode.PARAMS_ERROR, "评分结果名称过长");
        }
        ...
        if (appId != null){
            ...
            ThrowUtils.throwIf(app==null, ErrorCode.PARAMS_ERROR, "评分结果应用id非法");
        }
    }
